...
function cave3() {
  ...
  m.chests.push(
    { id: "cave3-helm", x: 25, y: 20, loot: { item: "captainCharm", qty: 1 }, label: "団結のお守り" },
...
export const ITEMS = Object.freeze({
  herb: { name: "薬草", type: "usable", price: 12, sell: 6, description: "味方ひとりのHPを35回復する。" },
  moonwort: { name: "月しずく草", type: "usable", price: 18, sell: 9, description: "毒・恐怖・オーラ低下を治す。" },
  auraDrop: { name: "オーラの雫", type: "usable", price: 65, sell: 32, description: "味方ひとりのMPを18回復する。" },
...
export const SKILLS = Object.freeze({
  ...
  captainCall: {
    ...
    target: "allAllies",
    effect: "captain",
    description: "味方全体の攻撃と守備を3ターン上げる。",
  },
  formation: {
    name: "鉄壁のフォーメーション",
    owner: "kumi",
