...
function renderDeployment(b){
 ...
 document.querySelectorAll('[data-v2439-dir]').forEach(btn=>btn.onclick=()=>changeAttackDirection(b,btn.dataset.v2439Dir));
 document.getElementById('v2439-auto').onclick=()=>autoPlayerDeployment(b);document.getElementById('v2439-start').onclick=()=>confirmDeployment(b);
}
